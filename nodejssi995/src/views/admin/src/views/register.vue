  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.17);borderRadius:10px">
        <h1 class="h1" style="color:rgba(36, 194, 205, 1);fontSize:28px;">在线教育注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机" type="text" />
																								...
																								<!-- <div v-if="tableName=='mingshi'" class="input-group">
			   <div class="label">工号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.gonghao" class="input" type="text" placeholder="工号">
			   </div>
			 </div> -->
			<el-form-item label="工号" class="input" v-if="tableName=='mingshi'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='mingshi'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='mingshi'" class="input-group">
			...
			<el-form-item label="教师姓名" class="input" v-if="tableName=='mingshi'">
			...
			<el-form-item label="职称" class="input" v-if="tableName=='mingshi'">
			  <el-input v-model="ruleForm.zhicheng" autocomplete="off" placeholder="职称" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='mingshi'" class="input-group">
			   <div class="label">教师手机</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiaoshishouji" class="input" type="text" placeholder="教师手机">
			   </div>
			 </div> -->
			<el-form-item label="教师手机" class="input" v-if="tableName=='mingshi'">
			  <el-input v-model="ruleForm.jiaoshishouji" autocomplete="off" placeholder="教师手机" type="text" />
			</el-form-item>
																					<!-- <div v-if="tableName=='mingshi'" class="input-group">
			...
			<el-form-item label="赞" class="input" v-if="tableName=='mingshi'">
			...
			<el-form-item label="踩" class="input" v-if="tableName=='mingshi'">
...
export default {
  ...
  methods: {
    ...
    login() {
        ...
        this.$message.error(`教师手机应输入手机格式`);
        return
      }
