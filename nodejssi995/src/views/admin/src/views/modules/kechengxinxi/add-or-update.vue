        ...
        <div v-else>
          <el-form-item v-if="ruleForm.kechengfengmian" label="课程封面" prop="kechengfengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.kechengfengmian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="在线课程" prop="zaixiankecheng">
          <file-upload
          tip="点击上传在线课程"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.zaixiankecheng?ruleForm.zaixiankecheng:''"
          @change="zaixiankechengUploadChange"
          ></file-upload>
        </el-form-item> 
        <div v-else>
          <el-form-item v-if="ruleForm.zaixiankecheng" label="在线课程" prop="zaixiankecheng">
            <el-button type="text" size="small" @click="download(ruleForm.zaixiankecheng)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
    ...
    back() {
      ...
      this.parent.contentStyleChange();
				...
				this.addEditUploadStyleChange()
                                ...
                                zaixiankechengUploadChange(fileUrls) {
                this.ruleForm.zaixiankecheng = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                                                    	addEditStyleChange() {
	  this.$nextTick(()=>{
